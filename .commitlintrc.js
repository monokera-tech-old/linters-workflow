module.exports = {
  ...
  extends: ['jira'],
  rules: {
    'jira-task-id-project-key': [2, 'always', ['VYP', 'CS', 'SRE', 'OPS', 'AF', 'AA', 'ALFA', 'ACC', 'SEG', 'RES', 'QA', 'CSY', 'BETA', 'DAT', 'RA', 'SY', 'RRA', 'FI', 'TI', 'RT', 'SDT', 'YI', 'SD', 'EP', 'BPY', 'NADM', 'FSC', 'SC', 'SB', 'TCK', 'PS', 'CR', 'MB', 'SPM', 'PLAN', 'PPS', 'MC', 'CB']],
